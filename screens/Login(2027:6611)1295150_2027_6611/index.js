...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <TouchableOpacity
        style={styles.TouchableOpacity_2027_6614}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("2058_8550"))
        }
      >
      ...
      <TouchableOpacity
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/a2d852c0-1d7f-449d-b556-f74daec1765a"
        }}
        style={styles.TouchableOpacity_2241_12377}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("2027_6619"))
        }
      />
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/10d5def0-d191-4515-b92e-cbd70eb09576"
        }}
